...
def compare_folders(
    ...
    if rand_proj:
        transformer = random_projection.GaussianRandomProjection(
            n_components=np_feats1.shape[0]
        )
        np_feats1 = transformer.fit_transform(np_feats1.T).T
    # print("!!!!! feature shape", np_feats1.shape)
    # print(a)
    ...
    if rand_proj:
        np_feats2 = transformer.fit_transform(np_feats2.T).T
