...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    # customize resolution
        ...
        resolution = 800, 450 #1280, 720 #480, 360 #159, 119
    ...
    mask_image = Image.fromarray(cam_info.mask)
    resized_mask = mask_image.resize(resolution, resample=Image.NEAREST)
    loaded_mask = torch.from_numpy(np.array(resized_mask)).float()
